...
// import { ZxingScannerComponent } from '@zxing/ngx-scanner/app/modules/zxing-scanner/zxing-scanner.component'
//import { ZXingScannerComponent } from './modules/zxing-scanner/zxing-scanner.module';
import { Result } from '@zxing/library';

@Component({
  selector: 'app-test-qrscanner',
  templateUrl: './test-qrscanner.component.html',
  styleUrls: ['./test-qrscanner.component.scss']
})
export class TestQrscannerComponent implements OnInit {
